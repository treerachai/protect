define( function( require, exports, module ) {
    ...
    */
    var operate = ( function() {
        ...
        //修改终端设备
        function updateTerminal( successCb ) {
            $loading.show();
        ...
        function deleteTerminal( id , successCb) {
            pop.warning( '是否删除终端设备,<br>此操作不可撤销, 请谨慎操作!' );
        ...
        ret = {
            ...
            */
            init: function( successCb , refresh) {
                if( !hasInit ) {
                    hasInit      = true;
                    success   = successCb;
                    bindClick();
