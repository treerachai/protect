define( function( require, exports, module ) {
	var terminalList = ( function() {
		...
		*/
		var Table       = require( 'strategy-react_table' ), //react组件
			...
			$JAllNum    = $( '.J-all_num' ),             //总条数
			$JSpage     = $( '.J-space' ),               //剩余空间数
			hasInit     = false, 
			ret;
			...
			ret = {
				init: function() {
					if( !hasInit ) {
						...
						//修改总条数和剩余空间数
						Deliver.subscribe( function( pageInfo ) {
							$JAllNum.text( pageInfo.pagenation.allNum );
							$JSpage.text( pageInfo.space );
						}, pagePub );
