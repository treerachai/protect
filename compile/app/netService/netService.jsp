...
<link rel="stylesheet" href="<c:url value="/public/css/netService-7bcd5193a6.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
        ...
        $( '.page-sidebar-menu li.deviceInfo li.netService' ).addClass( 'active open' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-xs-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">网络服务</span>
