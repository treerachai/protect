...
<link rel="stylesheet" href="<c:url value="/public/css/netSegment-c314cc1f6a.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
		$( '.page-sidebar-menu li.netSegment' ).addClass( 'active open' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-xs-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">网段管理</span>
                                <span class="caption-helper"></span>
                            </div>
                            <div class="tools">
                                <button class="u-btn u-radius J-add_ip">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">修改网段信息</h4>
            </div>
                        ...
                        <form class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">网段 <span class="required" aria-required="true"> * </span> </label>
                                    <div class="col-md-7">
                                        <input name="oldNetwork" type="hidden" class="form-control">
                                        <input name="newNetwork" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-footer">
                <div class="loading" style="display: none;"><img src="../public/img/running.gif"></div>
                        ...
                        <form class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">网段 <span class="required" aria-required="true"> * </span> </label>
                                    <div class="col-md-7">
                                        <input name="network" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">备注 </label>
