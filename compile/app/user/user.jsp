...
<link rel="stylesheet" href="<c:url value="/public/css/user-c314cc1f6a.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
		$( '.page-sidebar-menu li.userManage' ).addClass( 'active open' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-xs-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">用户管理</span>
                        ...
                        <form class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-xs-3">用户名 <span class="required" aria-required="true"> * </span> </label>
                                    <div class="col-xs-7">
                                        <input name="username" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-xs-3">授权IP1 </label>
                                    <div class="col-xs-7">
                                        <input name="ip1" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-xs-3">授权IP2 </label>
                                    <div class="col-xs-7">
                                        <input name="ip2" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-xs-3">授权IP3 </label>
                                    <div class="col-xs-7">
