...
<link rel="stylesheet" href="<c:url value="/public/css/guard-b6ebdaee43.css" />" type="text/css">
                ...
                <div class="col-xs-6">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">接入异常</span>
                        ...
                        <div class="portlet-body">
                            <div class="illegal_insert m-switch">
                                <label class="info">非法设备接入: </label>
                                <div class="state off"></div>
                                <select class="select" disabled="disabled">
                                    <option>报警</option>
                                    <optgroup label="阻断网络"></optgroup>
                                </select>
                            </div>
                            <div class="break_network m-switch">
                                <label class="info">合法设备断开网络: </label>
                                <div class="state off"></div>
                                <select class="select" disabled="disabled">
                                    <option>报警</option>
                                    <optgroup label="阻断网络"></optgroup>
                            ...
                            <div class="change_port m-switch">
                                <label class="info">合法设备更换端口: </label>
                                <div class="state off"></div>
                                <select class="select" disabled="disabled">
                                    <option>报警</option>
                                    <optgroup label="阻断网络"></optgroup>
				...
				<div class="col-xs-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <button class="u-btn u-radius add_terminal">添加</button>
                            </div>
                    	</div>
                        <div class="portlet-body terminal-wrapper">
                            <div id="terminal"></div>
                            <div class="loading">
                                <img src="./public/img/running.gif">
                            </div>
                            <div class="page relative center">
                                <ul id="terminal-page"></ul>
...
<div class="bootbox modal fade bootbox-alert" id="config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 287px;">
                <!--配置详情开始-->
                <div class="detail">
                    <!--表单开始-->
                    <div class="form">
