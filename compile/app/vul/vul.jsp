...
<link rel="stylesheet" href="<c:url value="/public/css/vul-a58765d935.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
        ...
        $( '.page-sidebar-menu li.deviceInfo li.vul' ).addClass( 'active open' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
				...
				<div class="col-xs-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">漏洞信息</span>
