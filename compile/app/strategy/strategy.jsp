...
<link href="<c:url value="/public/lib/metronic/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" />" rel="stylesheet" type="text/css">
...
<link rel="stylesheet" href="<c:url value="/public/css/strategy-f2ca7d1a7c.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
        ...
        $( '.page-sidebar-menu li.instruction li.strategy' ).addClass( 'active open' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content relative">
			...
			<!-- END PAGE HEADER-->
			<div class="row">
                <div class="col-xs-12 J-base">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">基础策略</span>
                                <span class="caption-helper"></span>
                            </div>
                            <div class="tools">
                                <div class="operate J-base">
                        ...
                        <div class="portlet-body page-wrapper">
                            <div id="page-list" class="table-scrollable">
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-xs-12">
                    <div class="portlet light J-private">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">私有漏洞探测</span>
                                <span class="caption-helper">高级策略</span>
                            </div>
                            <div class="tools">
                                <div class="operate">
                                    <button class="u-btn_error u-radius J-cancel" style="display:none;">
...
<script src="<c:url value="/public/lib/metronic/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js" />" type="text/javascript"></script>
