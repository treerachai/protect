...
<link rel="stylesheet" href="<c:url value="/public/css/systemset-af1556ce1c.css" />" type="text/css">
...
<div class="page-container">
	...
	<script>
        ...
        $( '.page-sidebar-menu li.config li.systemset' ).addClass( 'active' );
	</script>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
            ...
            <!-- <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="operate-wrap">
                        <div class="col-xs-6">
                            <button class="u-btn_warning reboot">重启电脑</button>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12">
                  <h1 class="reset-title">恢复出厂设置</h1>
                  <div class="line"></div>
                </div>
                <div class="col-xs-12">
                    <div class="operate-wrap">
                        <div class="col-xs-6">
                            <button class="u-btn_error reset">恢复出厂设置</button>
                        </div>
              ...
              <div class="col-xs-12">
                <div class="portlet light">
                  <div class="portlet-title">
                    <div class="caption">
                      <span class="caption-subject bold uppercase font-dark">重启电脑</span>
                  ...
                  <div class="portlet-title">
                    <div class="caption">
                      <span class="caption-subject bold uppercase font-dark">恢复出厂设置</span>
                      <span class="caption-helper"></span>
                    </div>
                    <div class="tools"></div>
                  </div>
